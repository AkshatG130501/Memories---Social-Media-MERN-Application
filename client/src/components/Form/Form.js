    ...
    return(
        <Paper className='paper'>
            <form autoComplete="off" noValidate className='root form' onSubmit={handleSubmit}>
                <div className="typo"><Typography variant="h6">Creating a Memory</Typography></div>
                ...
                <Button margin="8px" variant="contained" color="secondary" size="small" onClick={clear} fullWidth>Clear</Button>
            </form>
        </Paper>
    );
}
